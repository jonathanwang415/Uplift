...
with mdb.connect('localhost', 'root', 'toor', 'userdb') as cur:
    ...
    cur.execute(('INSERT INTO disease(phenotype_name, zero, one, two, three, four, s_one, s_two, s_three, s_four) VALUES(\'Colorectal Cancer\',' 
    ...
    cur.execute(('INSERT INTO disease(phenotype_name, zero, one, two, three, four, s_one, s_two, s_three, s_four) VALUES(\'Prostate Cancer\',' 
    ...
    cur.execute(('INSERT INTO personality(phenotype_name, zero, one, two, three, four) VALUES(\'depression\', \'Not easily depressed\',' 
