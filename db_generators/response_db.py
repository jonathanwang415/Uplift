...
with mdb.connect('localhost', 'simon123', '123', 'MYPHENOTYPES') as cur:
    ...
    N_threeSug = ''
    N_fourSug = ''
    cur.execute('INSERT INTO personalityTable(phenotype_name, zero, one, two, three, four, s_one, s_two, s_three, s_four) VALUES(\'Neuroticism\', \'Not easily neurotic\', \'slightly not easily neurotic\', \'intermediatly easily neurotic\', \'somewhat easily neurotic\', \'easily neurotic\', \'{}\', \'{}\', \'{}\', \'{}\')'.format(N_oneSug, N_twoSug, N_threeSug, N_fourSug))

    D_oneSug = ''
    D_twoSug = ''
    D_threeSug = ''
    D_fourSug = ''
    cur.execute('INSERT INTO personalityTable(phenotype_name, zero, one, two, three, four, s_one, s_two, s_three, s_four) VALUES(\'Depression\', \'Not easily depressed\', \'slightly not easily depressed\', \'intermediatly easily depressed\', \'somewhat prone to depression\', \'prone to depression\', \'{}\', \'{}\', \'{}\', \'{}\')'.format(D_oneSug, D_twoSug, D_threeSug, D_fourSug))
